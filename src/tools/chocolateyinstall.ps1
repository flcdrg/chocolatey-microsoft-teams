...
$packageName= 'microsoft-teams' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://statics.teams.microsoft.com/production-windows/1.0.00.6903/Teams_windows.exe' # download url, HTTPS preferred
